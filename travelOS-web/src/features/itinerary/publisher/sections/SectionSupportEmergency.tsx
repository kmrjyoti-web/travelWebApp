    ...
    <div>
      ...
      <div style={section}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10 }}>
          <div style={{ marginBottom: '0.75rem' }}>
            <TextField label="General Emergency" variant="outlined" size="sm" startIcon="Phone" value={se.emergencyNumber} onChange={(e) => update('supportEmergency', { ...se, emergencyNumber: e.target.value })} />
          </div>
          <div style={{ marginBottom: '0.75rem' }}>
            <TextField label="Police" variant="outlined" size="sm" startIcon="Phone" value={se.policeNumber} onChange={(e) => update('supportEmergency', { ...se, policeNumber: e.target.value })} />
          </div>
          <div style={{ marginBottom: '0.75rem' }}>
            <TextField label="Ambulance" variant="outlined" size="sm" startIcon="Phone" value={se.ambulanceNumber} onChange={(e) => update('supportEmergency', { ...se, ambulanceNumber: e.target.value })} />
          </div>
        </div>
      </div>
      ...
      <div style={section}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          <div style={{ marginBottom: '0.75rem' }}>
            <TextField label="Embassy Name" variant="outlined" size="sm" startIcon="Tag" value={se.embassyName} onChange={(e) => update('supportEmergency', { ...se, embassyName: e.target.value })} />
          </div>
          <div style={{ marginBottom: '0.75rem' }}>
            <TextField label="Phone" variant="outlined" size="sm" startIcon="Phone" value={se.embassyPhone} onChange={(e) => update('supportEmergency', { ...se, embassyPhone: e.target.value })} />
          </div>
          <div style={{ gridColumn: '1 / -1', marginBottom: '0.75rem' }}>
            <TextField label="Address" variant="outlined" size="sm" startIcon="MapPin" value={se.embassyAddress} onChange={(e) => update('supportEmergency', { ...se, embassyAddress: e.target.value })} />
          </div>
        </div>
      </div>
      ...
      <div style={section}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
          ...
          <Button size="sm" color="secondary" onClick={addHospital}><Icon name="Plus" size={12} /> Add</Button>
        </div>
        {se.hospitals.map((h, i) => (
          <div key={i} style={{ display: 'grid', gridTemplateColumns: '2fr 3fr 1fr auto', gap: 8, marginBottom: 6, alignItems: 'end' }}>
            <div style={{ marginBottom: '0.75rem' }}>
              <TextField label="Name" variant="outlined" size="sm" startIcon="Tag" value={h.name} onChange={(e) => updateHospital(i, { ...h, name: e.target.value })} />
            </div>
            <div style={{ marginBottom: '0.75rem' }}>
              <TextField label="Address" variant="outlined" size="sm" startIcon="MapPin" value={h.address} onChange={(e) => updateHospital(i, { ...h, address: e.target.value })} />
            </div>
            <div style={{ marginBottom: '0.75rem' }}>
              <TextField label="Phone" variant="outlined" size="sm" startIcon="Phone" value={h.phone} onChange={(e) => updateHospital(i, { ...h, phone: e.target.value })} />
            </div>
      ...
      <div style={section}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
          ...
          <Button size="sm" color="secondary" onClick={addContact}><Icon name="Plus" size={12} /> Add</Button>
        </div>
        {se.emergencyContacts.map((c, i) => (
          <div key={i} style={{ display: 'flex', gap: 8, marginBottom: 6, alignItems: 'center' }}>
            <div style={{ flex: 2 }}>
              <TextField label="Label" variant="outlined" size="sm" startIcon="User" value={c.label} onChange={(e) => updateContact(i, { ...c, label: e.target.value })} />
            </div>
            <div style={{ flex: 1 }}>
              <TextField label="Phone" variant="outlined" size="sm" startIcon="Phone" value={c.phone} onChange={(e) => updateContact(i, { ...c, phone: e.target.value })} />
            </div>
