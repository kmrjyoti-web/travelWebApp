/**
 * MobileInput size, variant, shape, and state style maps.
...
export const sizeStyles: Record<MobileInputSize, string> = {
  sm: "h-8 text-sm",
  md: "h-10 text-sm",
  lg: "h-12 text-base",
};
...
export const variantStyles: Record<MobileInputVariant, string> = {
  outlined:
...
export const shapeStyles: Record<MobileInputShape, string> = {
...
export const stateStyles: Record<MobileInputState, string> = {
  default:
