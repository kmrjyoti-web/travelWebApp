  ...
  return (
    <header className="h-14 bg-[var(--header-bg)] text-white flex items-center justify-between px-2 shrink-0 transition-colors duration-300 relative z-30">
      <div className="flex items-center space-x-4">
        ...
        <a 
          href="/login" 
          className="hidden sm:flex items-center bg-purple-500/20 hover:bg-purple-500/40 border border-purple-500/50 text-purple-100 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ml-2"
        >
          <span className="mr-1">✨</span> View Login UI
        </a>
