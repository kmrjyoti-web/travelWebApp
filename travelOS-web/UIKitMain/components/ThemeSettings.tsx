...
export default function ThemeSettings() {
  const { theme, updateTheme, resetTheme, isSettingsOpen, toggleSettings } = useTheme();
        ...
        <>
          ...
          >
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50">
              <button 
                onClick={resetTheme}
                className="w-full py-2.5 bg-red-500 hover:bg-red-600 text-white rounded font-medium shadow-sm transition-colors flex items-center justify-center space-x-2 relative overflow-hidden"
              >
                <span>Reset to Default</span>
                {/* Decorative element from screenshot */}
                <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-yellow-400/50 to-transparent flex items-center justify-center">
